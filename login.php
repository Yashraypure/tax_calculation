...
<head>
    ...
    <style>
        ...
        .button{
            ...
            border: 1px solid rgb(208, 16, 16);
            margin: 35px 0 10px;
            height: 32px;
            font-size: 12px;
            border-radius: 20px;
...
<div>
  ...
  <!--  <div> <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
        <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_d33g46k1.json"  background="transparent"  speed="1"  style="width: 1500px; height: 820px;"  loop  autoplay></lottie-player> -->
        <div class="a">
        <div class="c">
        <div class="ic" id="c">
       ...
       <!-- . /< <a href="D:\DBMSproject\html\form.html"> /< -->

        <input type="submit" name="submit" value="submit" class="button">
        
        <input type="checkbox"><span>Remember Me</span>   
        </form><a href="register.php">
        <button type="button"  class="button" > I'm New Here</a></button>

        <table class="z" cellspacing="20px">
            <tr>
...
<h1> JUST CHILL, LET US DO YOUR WORK :)</h1>
<script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
<lottie-player src="https://assets4.lottiefiles.com/packages/lf20_ucbyrun5.json"  background="transparent"  speed="2"  style="width: 1500px; height: 600px;"  loop  autoplay></lottie-player>
    </div>
