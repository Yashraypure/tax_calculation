...
.thstyle{background-color:rgba(182, 210, 224, 0.616);
  color:rgb(9, 7, 7);
font-size: 20;
font-family:cursive;
  ...
  <div class="topbar">
   ...
   <nav class="button">
    ...
    <ul>
      ...
      <li><button class="button"><a href="sregister.html"> Login/Register </a></button></li>
...
<div class="footer_container">
 <div class="upper_footer">
     ...
     <div class="footer_icons">
         ...
         <h2>Follow us on :</h2>
                  ...
                  <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_vuxwscfi.json"  background="transparent"  speed="1"  style="width: 200px; height: 200px;"  loop  autoplay></lottie-player>
                  <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                  <lottie-player src="https://assets10.lottiefiles.com/private_files/lf30_lttvuxbp.json"  background="transparent"  speed="1"  style="width: 200px; height: 243px;"  loop  autoplay></lottie-player></h2>
 ...
 <div class="footer_lower">
         <div class="about_us">
             ...
             <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
<lottie-player src="https://assets9.lottiefiles.com/packages/lf20_ystsffqy.json"  background="transparent"  speed="0.7"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
         </div>
