...
<input type="email" class="i" placeholder="Your Email Id" name="email" required><br>
<input type="password" class="i" placeholder=" Create Password" name="pwd" required><br>
...
<a href="login.php">
<button type="button" class="btn" > I have an account</button></a>
...
//error_reporting(0);
 ...
 //   $conpwd = $_POST['conpwd'];
    ...
    if ($num != 0) {
      ...
      $insert = "INSERT into admin(email,password) values('$email','$pwd')";
